...
var BCNEO_scriptSrc = document.getElementsByTagName('script')[document.getElementsByTagName('script').length - 1].src;
var BCNEO_scriptName = BCNEO_scriptSrc.split('/')[BCNEO_scriptSrc.split('/').length - 1];
var BCNEO_path = BCNEO_scriptSrc.replace(BCNEO_scriptName, '');
var BCMAIN_PATH = BCNEO_path + "../"

var __extends_neo = (this && this.__extends) || (function () {
...
(function (Neo) {
    ...
    (function (Cryptography) {
        ...
        var AesCryptoKey = (function (_super) {
            __extends_neo(AesCryptoKey, _super);
        ...
        var ECDsaCryptoKey = (function (_super) {
            __extends_neo(ECDsaCryptoKey, _super);
...
(function (Neo) {
    ...
    (function (IO) {
        ...
        var MemoryStream = (function (_super) {
            __extends_neo(MemoryStream, _super);
...
(function (ThinNeo) {
    ...
    var Helper = (function () {
        ...
        Helper.GetNep2FromPrivateKey = function (prikey, passphrase, n, r, p, callback) {
            ...
            scrypt.setResPath(BCMAIN_PATH + 'lib/asset');
            ...
            scrypt.oncomplete = function (dk) {
                console.log("[BlaCat]", '[GetNep2FromPrivateKey]','[scrypt.oncomplete]', scrypt.binToHex(dk));
            ...
            scrypt.onprogress = function (percent) {
                console.log("[BlaCat]", '[GetNep2FromPrivateKey]', '[scrypt.onprogress]');
            };
        ...
        Helper.GetPrivateKeyFromNep2 = function (nep2, passphrase, n, r, p, callback) {
            ...
            scrypt.oncomplete = function (dk) {
                console.log("[BlaCat]", '[GetPrivateKeyFromNep2]', '[scrypt.oncomplete]', scrypt.binToHex(dk));
                var u8dk = new Uint8Array(dk);
                var derivedhalf1 = u8dk.subarray(0, 32);
                var derivedhalf2 = u8dk.subarray(32, 64);
            ...
            scrypt.onprogress = function (percent) {
                console.log("[BlaCat]", '[GetPrivateKeyFromNep2]', '[scrypt.onprogress]');
            };
            scrypt.onready = function () {
                var passbin = scrypt.strToBin(passphrase);
                scrypt.hash(passbin, addresshash, 64);
