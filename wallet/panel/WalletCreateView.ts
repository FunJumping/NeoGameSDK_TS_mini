                    ...
                    ThinNeo.Helper.GetNep2FromPrivateKey(
                        ...
                        async (info, result) => {
                            if (info == "finish") {
                                ...
                                // 下载钱包
                                this.remove();
                                WalletCreateDownloadView.filestr = jsonstr
                                WalletCreateDownloadView.filepass = this.inputPwd.value
                                WalletCreateDownloadView.addr = addr
                                Main.viewMgr.change("WalletCreateDownloadView")
                            }
