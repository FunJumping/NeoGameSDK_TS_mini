...
namespace BlackCat {
    ...
    export class IconView extends ViewBase {
        ...
        private dragTouch(ev) {
            ...
            // console.log("[BlaCat]", '[IconView]', '[dragTouch]', 'sent => ', sent)
            ...
            document.ontouchmove = (ev: any) => {
                // console.log("[BlaCat]", '[IconView]', '[onmousemove]', 'start ..')
                // 鼠标移动
            ...
            document.ontouchend = () => {
                // console.log("[BlaCat]", '[IconView]', '[ontouchend]', 'start ..')
                // 鼠标松开
        ...
        private drag() {
            // console.log("[BlaCat]", '[IconView]', '[drag]', 'start ..')
            ...
            // console.log("[BlaCat]", '[IconView]', '[drag]', 'sent => ', sent)
            ...
            this.div.onmousedown = (ev) => {
                // console.log("[BlaCat]", '[IconView]', '[onmousedown]', 'start ..')
                // 鼠标按下，开始拖动
                this.doDragMove = false;
                var oEvent = ev;
                var sentX = oEvent.clientX - this.div.offsetLeft;
                ...
                document.onmouseup = () => {
                    // console.log("[BlaCat]", '[IconView]', '[onmouseup]', 'start ..')
                    // 鼠标松开
